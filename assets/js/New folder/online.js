...
const _coupCards = {
    duke: { name:'الشلغمي', icon:'👑', img:'../assets/images/assets/coup/duke.png', img512:'../assets/images/assets/coup/duke512.png', attack:'هجوم: ياخو 3 فلوس من البنك.', defense:'دفاع: يسكّر اعانة +2 متاع أي لاعب.' },
    assassin: { name:'حفار القبور', icon:'🗡️', img:'../assets/images/assets/coup/assassin.png', img512:'../assets/images/assets/coup/assassin512.png', attack:'هجوم: يدفع 3 فلوس ويخلي لاعب يختار كارتة يخسرها.', defense:'دفاع: ما عندوش دفاع، أما claim متاعو ينجم يتكذّب.' },
    contessa: { name:'البية', icon:'💃', img:'../assets/images/assets/coup/contessa.png', img512:'../assets/images/assets/coup/contessa512.png', attack:'هجوم: ما عندهاش هجوم.', defense:'دفاع: تسكّر الاغتيال متاع حفار القبور.' },
    ambassador: { name:'السمسار', icon:'🤝', img:'../assets/images/assets/coup/ambassador.png', img512:'../assets/images/assets/coup/ambassador512.png', attack:'هجوم: يبدّل كوارطو الحيّة مع الدكّة، أو يعمل روحو بدّل.', defense:'دفاع: يسكّر سرقة الرايس.' },
    captain: { name:'الرايس', icon:'⚓', img:'../assets/images/assets/coup/captain.png', img512:'../assets/images/assets/coup/captain512.png', attack:'هجوم: يسرق حتى زوز فلوس من لاعب آخر.', defense:'دفاع: يسكّر سرقة الرايس.' }
};
...
function _renderChkobbaPiles(state, me) {
    ...
    deckEl.style.backgroundImage = "url('../assets/images/cardpile-right.webp')";
    ...
    capEl.style.backgroundImage = "url('../assets/images/cardpile-left.webp')";
